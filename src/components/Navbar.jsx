  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 text-white p-4 dark:bg-darkPrimary flex items-center justify-between shadow-md">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-lg font-bold">Sachin Singh's Portfolio</div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="hidden md:flex text-xl gap-2">
          <a href="https://github.com/SachinSingh07" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500 transition duration-300">
            <FaGithub />
          </a>
          ...
          <a href="https://www.linkedin.com/in/sachin-singh-aa4b74263" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500 transition duration-300">
            <FaLinkedin />
          </a>
        </div>
