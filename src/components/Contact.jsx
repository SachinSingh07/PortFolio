    ...
    <div className='border-b border-neutral-900 pb-8'>
      ...
      <div className="text-center tracking-tighter">
        ...
        <motion.p
          ...
          <a href="https://github.com/SachinSingh07" target="_blank" rel="noopener noreferrer" className="ml-1">
            {CONTACT.Github}
          </a>
        </motion.p>
        <motion.p
          ...
          <a href="https://www.linkedin.com/in/sachin-singh-aa4b74263" target="_blank" rel="noopener noreferrer" className="ml-1">
            {CONTACT.linkdin}
          </a>
        </motion.p>
        <motion.p
